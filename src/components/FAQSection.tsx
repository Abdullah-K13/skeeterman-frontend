...
const faqs = [
  ...
  { q: "What's included in a regular pest control service?", a: "Technicians apply conscious products around the home's perimeter, entryways, and other high-risk areas to eliminate and deter pests." },
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((f, i) => (
              <AccordionItem
                key={i}
                value={`item-${i}`}
                className="glass rounded-xl border-gradient px-4 sm:px-6 border-none"
              >

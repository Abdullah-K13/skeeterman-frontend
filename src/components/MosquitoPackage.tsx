...
const addOnServices = [
  ...
  "Deer Repellent", "Snake Repellent", "Rabbit Repellent",
];
    ...
    <section id="services" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Add-on services */}
          <div className="reveal-left card-3d glass rounded-2xl p-8 border-gradient">
          ...
          {/* IPM */}
          <div className="reveal-right card-3d glass rounded-2xl p-8 border-gradient">
            <h4 className="font-display text-2xl font-bold text-foreground mb-6">
